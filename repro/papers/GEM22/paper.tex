...
The author received no funding from any source in the performance of
the work reported here, nor does he have any financial or
non-financial interests relevant to the content of this article. The
computations described were developed in the Madagascar reproducible
research framework (www.reproducibility.org). The software source is
