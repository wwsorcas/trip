...
\end{eqnarray}
Assume that the normal operator $F^T F + \alpha^2 A^T A$ is boundedly invertible, as for example in Theorem \ref{thm:norminv}. Then the solution of $\aw$ of the
normal equation \ref{eqn:norm}
is smooth in $\alpha^2$.
Differentiating equation the normal equation  
with respect to  $\alpha^2$ leads to the relation
\begin{equation}
