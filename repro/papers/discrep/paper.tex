...
mathematical results and supporting discussion, followed by
derivations. In particular, theorems referenced in the Overview
section are to be found, stated in full with their proofs, in the this
final part of the paper. Three appendices describe the algorithm used to
control the penalty weight in our formulation of extended
inversion, further refinement of error estimates based ond the
Heisenberg inequality, and the abstract structure of objective derivatives
inherent in extended inversion based on wave propagation.
...
approaches for inverse problems in wave propagation. See for example \cite{Symes:EAGE15}.
...
\begin{proof} of Theorem \ref{thm:norminv}:
  \begin{itemize}
