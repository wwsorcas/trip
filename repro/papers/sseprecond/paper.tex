...
Another figure \ref{fig:ddifffwdaltplh0}
More figures: \ref{fig:compnrestrunc0lh0}, \ref{fig:compnrestrunc1lh0}.
...
\plot{ddiffprednshsrecphh0}{width=\textwidth}{Plot of difference 
  between data shown in Figures \ref{fig:drecphh0} and 
  \ref{fig:dprednshsrecphh0}, plotted on same color scale as the latter 
  two figures.}
...
\plot{compres0hh0}{width=\textwidth}{Comparison of residual Euclidean 
  norms: CG (blue), PCG (red), plotted vs. iteration. Data =
  homogeneous model, point source (Figure \ref{fig:recphh0}), inversion 
  in homogeneous model. Penalty weight
  $\alpha=0$.}

\plot{compres0lh0}{width=\textwidth}{Comparison of residual Euclidean 
  norms: CG (blue), PCG (red), plotted vs. iteration. Data =
  lens model, point source (Figure \ref{fig:recplh0}), inversion 
  in homogenous model. Penalty weight 
  $\alpha=0$.}

\plot{compres0ll0}{width=\textwidth}{Comparison of residual Euclidean 
  norms: CG (blue), PCG (red), plotted vs. iteration. Data =
  lens model, point source (Figure \ref{fig:recplh0}), inversion 
  in lens model. Penalty weight 
  $\alpha=0$.}

\plot{compres1hh0}{width=\textwidth}{Comparison of residual Euclidean 
  norms: CG (blue), PCG (red), plotted vs. iteration. Data =
  homogeneous model, point source (Figure \ref{fig:recphh0}), inversion 
  in homogenous model. Penalty weight 
  $\alpha=10^{-3}$.}

\plot{compres1lh0}{width=\textwidth}{Comparison of residual Euclidean 
  norms: CG (blue), PCG (red), plotted vs. iteration. Data =
  lens model, point source (Figure \ref{fig:recplh0}), inversion 
  in homogenous model. Penalty weight 
  $\alpha=10^{-3}$.}

\plot{compres1ll0}{width=\textwidth}{Comparison of residual Euclidean 
  norms: CG (blue), PCG (red), plotted vs. iteration. Data =
  lens model, point source (Figure \ref{fig:recplh0}), inversion 
  in lens model. Penalty weight
  $\alpha=0$.}

\plot{compnres0hh0}{width=\textwidth}{Comparison of normal residual
  (gradient) Euclidean norms: CG (blue), PCG (red), plotted
  vs. iteration. Data = homogeneous model, point source (Figure
  \ref{fig:recphh0}), inversion in homogenous model. Penalty weight $\alpha=0$.}

\plot{compnres0lh0}{width=\textwidth}{Comparison of normal residual 
  (gradient) Euclidean norms: CG (blue), PCG (red), plotted 
  vs. iteration. Data = lens model, point source (Figure 
  \ref{fig:recplh0}), inversion in homogenous model. Penalty weight 
  $\alpha=0$.}

\plot{compnres0ll0}{width=\textwidth}{Comparison of normal residual 
  (gradient) Euclidean norms: CG (blue), PCG (red), plotted 
  vs. iteration. Data = lens model, point source (Figure 
  \ref{fig:recplh0}), inversion in lens model. Penalty weight 
  $\alpha=0$.}

\plot{compnrestrunc0lh0}{width=\textwidth}{Comparison of normal residual 
  (gradient) Euclidean norms: CG (blue), PCG (red), plotted 
  vs. iteration. Data = lens model, point source (Figure 
  \ref{fig:recplh0}), inversion in homogenous model. Penalty weight 
  $\alpha=0$.}

\plot{compnrestrunc0ll0}{width=\textwidth}{Comparison of normal residual 
  (gradient) Euclidean norms: CG (blue), PCG (red), plotted 
  vs. iteration. Data = lens model, point source (Figure 
  \ref{fig:recplh0}), inversion in lens model. Penalty weight 
  $\alpha=0$.}

\plot{compnres1hh0}{width=\textwidth}{Comparison of normal residual 
  (gradient) Euclidean norms: CG (blue), PCG (red), plotted 
  vs. iteration. Data = homogeneous model, point source (Figure 
  \ref{fig:recphh0}), inversion in homogenous model. Penalty weight 
  $\alpha=10^{-3}$.}
...
\plot{compnres1ll0}{width=\textwidth}{Comparison of normal residual 
  (gradient) Euclidean norms: CG (blue), PCG (red), plotted 
  vs. iteration. Data = lens model, point source (Figure 
  \ref{fig:recplh0}), inversion in lens model. Penalty weight
  $\alpha=10^{-3}$.}

\plot{compnrestrunc1lh0}{width=\textwidth}{Comparison of normal residual 
  (gradient) Euclidean norms: CG (blue), PCG (red), plotted 
  vs. iteration. Data = lens model, point source (Figure 
  \ref{fig:recplh0}), inversion in homogenous model. Penalty weight 
  $\alpha=10^{-3}$.}

\plot{compnrestrunc1ll0}{width=\textwidth}{Comparison of normal residual 
  (gradient) Euclidean norms: CG (blue), PCG (red), plotted 
  vs. iteration. Data = lens model, point source (Figure 
  \ref{fig:recplh0}), inversion in lens model. Penalty weight
  $\alpha=10^{-3}$.}
...
\plot{ddifffwdaltplh0}{width=\textwidth}{Diff}
...
A plot of the model with rays overlain, \ref{fig:olensrays0}.

\plot{olensrays0}{width=\textwidth}{Lens model with rays.}
