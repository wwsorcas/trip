...
void UpdateVel(Field * restrict sim, const Field & restrict buoy, real ** restrict coeff, int radius, int top, int bottom, int top_bc);
void UpdateStress(Field * restrict sim, Field ** restrict stiffness_ptr, real ** restrict coeffs, int radius, int top, int bottom, int top_bc);
void Jacobi2D(Array & restrict X, Array & restrict A, Array & restrict B, int n0, int n1, real tol, Array & restrict X_tmp);
real Norm2D(Array & restrict X1, Array & restrict X2, int n0, int n1, int mode);
void UpdateGhostSXZ(Field * restrict sim1, Field * restrict sim2,
                    Field & restrict buoy1, Field & restrict buoy2,
                    real ** restrict coeff1, real ** restrict coeff2,
                    Array & restrict g_sxz2, Array & restrict A, Array & restrict B,
                    Array & restrict g_tmp, int mode);
void UpdateGhostSYZ(Field * restrict sim1, Field * restrict sim2,
                    Field & restrict buoy1, Field & restrict buoy2,
                    real ** restrict coeff1, real ** restrict coeff2, int mode);
void UpdateGhostVZ(Field * restrict sim1, Field * restrict sim2,
                   Field ** restrict stiff1, Field ** restrict stiff2,
                   real ** restrict coeff1, real ** restrict coeff2,
                   Array & restrict A, Array & restrict B, int mode);

/*
void UpdateVel(Field * sim, const Field & buoy, real ** coeff, int radius, int top, int bottom, int top_bc);
void UpdateStress(Field * sim, Field ** stiffness_ptr, real ** coeffs, int radius, int top, int bottom, int top_bc);
