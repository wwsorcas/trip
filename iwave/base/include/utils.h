...
/*----------------------------------------------------------------------------*/
#define USERMALLOC_ALIGN_BYTES 64
/**< 
   alignment of pointers returned by malloc

   used in usermalloc_, defined in utils.c
   >*/
...
/*----------------------------------------------------------------------------*/
/* 
   Determine whether communicator is at boundary of cartesian comm along
   each axis
*/
...
/*----------------------------------------------------------------------------*/
/* 
functions useful in definint mute and taper operations
*/
