...
const char *sdoc[] = {
  ...
  " ",
  " Acoustic variable density centered difference modeling for single scalar",
  ...
  " \"asg_p_scal.x [parameters] [standalone install]\"",
  " ",
...
int main(int argc, char ** argv) {
  ...
  try {
    ...
    //applying op
    RVL::OperatorEvaluation<ireal> opeval(F,x);
