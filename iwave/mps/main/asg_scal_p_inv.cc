...
const char *sdoc[] = {
  ...
  " Forward map F(m), ",
  "       F(m)w = d",
  "       m = (m[0],m[1]) = medium parameters (bulk modulus and buoyancy resp.)",
  ...
  "      MPS_file = <path>   MPS file containing estimated MPS coefficients, SU format - must exist",
