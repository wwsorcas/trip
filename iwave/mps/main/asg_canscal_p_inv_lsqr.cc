...
const char *sdoc[] = {
  ...
  "          stack = (optional)    flag for stacking inverted sources, 1=true, 0=false",
  " ---------------------------end parameters ------------------------------",
  NULL };
...
int main(int argc, char ** argv) {
  ...
  try {
	...
	exit(0);
      ...
      cerr << "\n////////////////////////////////////////////////////////////\n"
	   << "Running asg_canscal_p_inv_lsqr.x\n";
    ...
    */
    ...
    FunctionalEvaluation<ireal> eval(F_red,m);
    float val = eval.getValue();
    res << "VPM value = 0.5*|F[m]w-d|^2 = "<< val << "\n";

    VPM< ireal,LSQRPolicy<ireal>,LSQRPolicyData<ireal> > const &fcp =
      dynamic_cast< VPM< ireal,LSQRPolicy<ireal>,LSQRPolicyData<ireal> > const &>(eval.getFunctional());
    ...
    */
    ...
    if(retrieveGlobalRank()==0){
      ...
      cerr << "\nFinishing asg_canscal_p_inv_lsqr.x\n"
	   << "////////////////////////////////////////////////////////////\n";
