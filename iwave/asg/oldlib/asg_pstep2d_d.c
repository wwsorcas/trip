...
void asg_pstep2d_d(float ** restrict bulk,
  ...
  for (i1 = gsc[1]; i1 < gec[1]+1; ++i1) {
    for (i0 = gsc[0]; i0 < gec[0]+1; ++i0) {
      sdivd[i0] =
	c[0][0]*(v0d[i1][i0]-v0d[i1][i0-1]) +
	c[1][0]*(v1d[i1][i0]-v1d[i1-1][i0]);
      sdiv[i0] =
    ...
    for (i0 = gsc[0]; i0 < gec[0]+1; ++i0) {
      p0d[i1][i0] = epp[0][i0]*
	(ep[0][i0]*p0d[i1][i0]
	 -bulkd[i1][i0]*sdiv[i0]-bulk[i1][i0]*sdivd[i0]);
      p0[i1][i0] = (p0[i1][i0]*ep[0][i0]-
		    bulk[i1][i0]*sdiv[i0])*epp[0][i0];
      p1d[i1][i0] = epp[1][i1]*(ep[1][i1]*p1d[i1][i0]-
				bulkd[i1][i0]*sdiv[i0]-bulk[i1][i0]*sdivd[i0]);
      p1[i1][i0] = (p1[i1][i0]*ep[1][i1]-
		    bulk[i1][i0]*sdiv[i0])*epp[1][i1];
    }
  }
