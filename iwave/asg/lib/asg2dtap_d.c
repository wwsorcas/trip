...
void asg2dtap_d(float *** __restrict__ bulk, float *** __restrict__ bulkd,
		float ** __restrict__ buoy, float ** __restrict__ buoyd,
		float ** __restrict__ p0, float **  __restrict__ p0d,
		float ** __restrict__ p1, float ** __restrict__ p1d,
		float ** __restrict__ v0, float ** __restrict__ v0d,
		float ** __restrict__ v1, float ** __restrict__ v1d,
		float ** __restrict__ ep, float ** __restrict__ epp,
		float ** __restrict__ ev, float ** __restrict__ evp,
		float ** __restrict__ sdiv, float ** __restrict__ sdivd,
		float ** __restrict__ sdivb, float ** __restrict__ sdivbd,
