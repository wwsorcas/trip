...
#pragma GCC ivdep
      for (int i0=gsc_p[0]; i0 <= gec_p[0]; i0++) {      
	p0[i1][i0] = (ep[0][i0]*p0[i1][i0] - dh * bulk[0][i1][i0]*sdiv[i1-gscp1][i0-gscp0])*epp[0][i0];
	p1[i1][i0] = (ep[1][i1]*p1[i1][i0] - dh * bulk[0][i1][i0]*sdiv[i1-gscp1][i0-gscp0])*epp[1][i1]; 
	//	    dh * bulk[ih+ihmax][i1-ih][i0] * sdiv[i1-gsc_p[1]-2*ih][i0-gsc_p[0]];
      }
    }
