...
void asg2dtap_b(float *** __restrict__ bulk, float *** __restrict__ bulkb,
		float ** __restrict__ buoy, float ** __restrict__ buoyb,
		float ** __restrict__ p0, float ** __restrict__ p0b,
		float ** __restrict__ p1, float ** __restrict__ p1b,
		float ** __restrict__ v0, float ** __restrict__ v0b,
		float ** __restrict__ v1, float ** __restrict__ v1b,
		float ** __restrict__ ep, float ** __restrict__ epp,
		float ** __restrict__ ev, float ** __restrict__ evp,
		float ** __restrict__ sdiv, float ** __restrict__ sdivb0,
		float ** __restrict__ sdivb, float ** __restrict__ sdivbb, 
		float * __restrict__ gradp0, float * __restrict__ gradp0b, 
		float * __restrict__ gradp1, float * __restrict__ gradp1b,
		int * gsc_p, int *gec_p,
		int *gsc_v0, int *gec_v0,
		int *gsc_v1, int *gec_v1,
		int *lbc, int *rbc,
		float dh, int ihmax,
		int maxoff, float ** __restrict__ c,
		FILE * stream) {
  int i0, i1;
  int ioff;
  {
...
#pragma GCC ivdep
	for (i0 = gec_p[0]; i0 > gsc_p[0]-1; --i0) {
	  bulkb[ih+ihmax][i1-ih][i0] +=
	    sdiv[i1-gsc_p[1]-2*ih][i0-gsc_p[0]]*sdivbb[i1-gsc_p[1]][i0-gsc_p[0]];
	  sdivb0[i1 - gsc_p[1] - 2*ih][i0 - gsc_p[0]] += 
	    dh*bulk[ih+ihmax][i1-ih][i0]*sdivbb[i1-gsc_p[1]][i0-gsc_p[0]];
	}
      }
    }
