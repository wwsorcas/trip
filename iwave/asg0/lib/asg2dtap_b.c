...
void asg2dtap_b(float *** restrict bulk, float *** restrict bulkb,
		float ** restrict buoy, float ** restrict buoyb,
		float ** restrict p0, float ** restrict p0b,
		float ** restrict p1, float ** restrict p1b,
		float ** restrict v0, float ** restrict v0b,
		float ** restrict v1, float ** restrict v1b,
		float ** restrict ep, float ** restrict epp,
		float ** restrict ev, float ** restrict evp,
		float ** restrict sdiv, float ** restrict sdivb0,
		float ** restrict sdivb, float ** restrict sdivbb, 
		float * restrict gradp0, float * restrict gradp0b, 
		float * restrict gradp1, float * restrict gradp1b,
		int * gsc_p, int *gec_p,
