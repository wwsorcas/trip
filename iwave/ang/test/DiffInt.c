...
void MultFreq (float *Trace, int Nt, float dt, float complex *Aux, int nfft, int power, float *band);
void DiffInt  (float *Trace, int Nt, float dt, float complex *Aux, int nfft, int power, float *band);
...
int main() {
	...
	Aux   = (float complex*)calloc (3*nfft, sizeof(float complex));
