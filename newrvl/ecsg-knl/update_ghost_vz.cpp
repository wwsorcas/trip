...
void UpdateGhostVZ(Field * restrict sim1, Field * restrict sim2,
                   ...
                   Array & restrict A, Array & restrict B,
                   int mode)
{
    Field& vx1 = sim1[0];
    Field& vy1 = sim1[1];
...
#pragma ivdep
            ...
            //use extrapolation to update boundary to ensure second order accuracy
#ifdef _OPENMP
#pragma omp for
#endif
            for(int i1 = 0; i1 < ny2; i1++)
            {
                int i0 = vz2.GetStart(0);
                vz1.SetVal(2*i0,2*i1,nz1) = vz1.GetVal(2*i0,2*i1,nz1-1)*2/3
                - vz1.GetVal(2*i0+1,2*i1,nz1-1)/3
                + vz2.GetVal(i0,i1,0)*2/3;
                
                vz1.SetVal(2*i0,2*i1+1,nz1) = vz1.GetVal(2*i0,2*i1+1,nz1-1)*2/3
                - vz1.GetVal(2*i0+1,2*i1+1,nz1-1)/3
                + vz2.GetVal(i0,i1,0)/3
                + vz2.GetVal(i0,i1+1,0)/3;
                
                i0 = vz2.GetEnd(0);
                vz1.SetVal(2*i0+1,2*i1,nz1) = vz1.GetVal(2*i0+1,2*i1,nz1-1)*2/3
                - vz1.GetVal(2*i0,2*i1,nz1-1)/3
                + vz2.GetVal(i0,i1,0)*2/3;
                
                vz1.SetVal(2*i0+1,2*i1+1,nz1) = vz1.GetVal(2*i0+1,2*i1+1,nz1-1)*2/3
                - vz1.GetVal(2*i0,2*i1+1,nz1-1)/3
                + vz2.GetVal(i0,i1,0)/3
                + vz2.GetVal(i0,i1+1,0)/3;
            }
        }
